            ...
            <div>
                ...
                <div className='p-3 flex flex-row items-start bg-gray-900'>
                    <div className='bg-gray-900 p-3 border-b-4 border-green-400 max-w-sm'>
                        ...
                        <h1 className='text-white font-semibold text-xl leading-8 my-1'>SHISHIRO</h1>
                            ...
                            <div className="text-white rounded-sm border-b-4 border-green-400">
                                <div className="grid md:grid-cols-2 text-sm">
                                    <div className="grid grid-cols-2">
                                        ...
                                        <div className="px-4 py-2">Shishiro</div>
                                    </div>
                                    <div className="grid grid-cols-2">
                                        <div className="px-4 py-2 font-semibold">Last Name</div>
                                        <div className="px-4 py-2">Bannu</div>
                                    </div>
                                    <div className="grid grid-cols-2">
                                        <div className="px-4 py-2 font-semibold">Contact No.</div>
                                        <div className="px-4 py-2">+91 999999999</div>
                                    </div>
                                    <div className="grid grid-cols-2">
                                        <div className="px-4 py-2 font-semibold">Email.</div>
                                        <div className="px-4 py-2">
                                            <a className="text-blue-800" href="test@example.com">test@example.com</a>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2">
