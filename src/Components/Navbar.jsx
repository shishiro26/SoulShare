const Navbar = () => {
  return (
    <aside className="mt-0 bg-gray-50 dark:bg-gray-900 bg-gray-800">
    <nav className="sticky top-0 flex flex-col justify-between center max-w-[48px] bg-gray-50 dark:bg-gray-900 bg-gray-800">
