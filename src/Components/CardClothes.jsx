    ...
    >
      <div className="w-[100%] h-[300px] overflow-hidden object-cover  ">
        <img
          ...
          width="500"
          height="600"
          className="hover:scale-105 ease-in-out duration-[350] transition-all"
        />
        <div id="Heart" className="absolute  top-0 right-0 mr-4 mt-6 ">
          <button
            aria-label="Add to wishlist: Jibhi, India"
            data-testid="listing-card-save-button"
            type="button"
            className="mx-4 "
            fdprocessedid="lrnu38"
        ...
        <div className="flex justify-between mx-4 my-1   ">
          ...
          <div id="Distance">
            <span
              ...
              className="mx-2  bg-gray-800 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded mr-2 dark:bg-gray-700 dark:text-gray-400 border border-gray-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
